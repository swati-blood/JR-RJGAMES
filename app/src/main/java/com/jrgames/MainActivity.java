...
import com.jrgames.Model.UsersObjects;
...
RelativeLayout login_register_btn,btnRegister;
    private Button btnForgetPassword,btnForgetUserID;
...
//       lay_u_name=findViewById(R.id.lay_user_name);
        ...
        module = new Module();
        btnRegister=(RelativeLayout)findViewById(R.id.login_register_btn);
...
//                    return;
                if(etName.getText ().toString ().isEmpty ()){
                    etName.setError ("Mobile No. Required");
                    etName.requestFocus ();

                } else if (mName.length ( ) != 10) {
            etName.setError ("Invalid Mobile No.");
            etName.requestFocus ( );
