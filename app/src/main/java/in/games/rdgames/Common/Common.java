package in.games.rdgames.Common;
...
import in.games.rdgames.Adapter.ListItemAdapter;
import in.games.rdgames.Adapter.TableAdaper;
import in.games.rdgames.AppController;
...
import in.games.rdgames.MainActivity;
import in.games.rdgames.Model.MatkasObjects;
import in.games.rdgames.Model.Starline_Objects;
import in.games.rdgames.Model.TableModel;
import in.games.rdgames.Model.WalletObjects;
import in.games.rdgames.NewGameActivity;
import in.games.rdgames.Prevalent.Prevalent;
import in.games.rdgames.R;
...
import in.games.rdgames.utils.Module;
...
public class Common {
    ...
    public void setBetTypeTooText( Dialog dialog, final TextView txt_timer, TextView txtOpen, TextView txtClose, String m_id, final Button btnType, LoadingBar progressDialog, final String c_date, final TextView tv_timer)
    {
