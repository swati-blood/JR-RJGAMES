package in.games.rdgames.utils;
...
import in.games.rdgames.HomeActivity;

import static in.games.rdgames.Config.Constants.IS_LOGIN;
import static in.games.rdgames.Config.Constants.KEY_ACCOUNNO;
import static in.games.rdgames.Config.Constants.KEY_ADDRESS;
import static in.games.rdgames.Config.Constants.KEY_BANK_NAME;
import static in.games.rdgames.Config.Constants.KEY_CITY;
import static in.games.rdgames.Config.Constants.KEY_DIALOG;
import static in.games.rdgames.Config.Constants.KEY_DOB;
import static in.games.rdgames.Config.Constants.KEY_EMAIL;
import static in.games.rdgames.Config.Constants.KEY_HOLDER;
import static in.games.rdgames.Config.Constants.KEY_ID;
import static in.games.rdgames.Config.Constants.KEY_IFSC;
import static in.games.rdgames.Config.Constants.KEY_MOBILE;
import static in.games.rdgames.Config.Constants.KEY_NAME;
import static in.games.rdgames.Config.Constants.KEY_PAYTM;
import static in.games.rdgames.Config.Constants.KEY_PHONEPAY;
import static in.games.rdgames.Config.Constants.KEY_PINCODE;
import static in.games.rdgames.Config.Constants.KEY_TEZ;
import static in.games.rdgames.Config.Constants.KEY_USER_NAME;
import static in.games.rdgames.Config.Constants.KEY_WALLET;
import static in.games.rdgames.Config.Constants.PREFS_NAME;
